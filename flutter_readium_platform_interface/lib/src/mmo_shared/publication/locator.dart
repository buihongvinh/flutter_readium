...
class Locator with EquatableMixin implements JSONable {
  ...
  Locator copy({String? href, String? type, String? title, Locations? locations, LocatorText? text}) => Locator(
    href: href ?? this.href,
    type: type ?? this.type,
...
class Locations with EquatableMixin implements JSONable {
  ...
  @override
  List<Object?> get props => [position, progression, totalProgression, fragments, otherLocations];
