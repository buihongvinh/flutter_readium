...
class LocalizedString with EquatableMixin, JSONable {
  ...
  LocalizedString copyWithString(String language, String string) =>
      copy(translations: Map.from(translations)..putIfAbsent(language, () => Translation(string)));

  /// Returns a new [LocalizedString] after applying the [transform] function to each language.
  LocalizedString mapLanguages(String Function(String?, Translation) transform) => copy(
  ...
  LocalizedString mapTranslations(Translation Function(String?, Translation) transform) => copy(
