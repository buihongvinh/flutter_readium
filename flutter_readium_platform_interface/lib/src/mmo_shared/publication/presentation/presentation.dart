...
class PresentationFit with EquatableMixin {
  ...
  static PresentationFit? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
...
class EpubLayout with EquatableMixin {
  ...
  static EpubLayout? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
...
class PresentationOrientation with EquatableMixin {
  ...
  static PresentationOrientation? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
...
class PresentationOverflow with EquatableMixin {
  ...
  static PresentationOverflow? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
...
class PresentationPage with EquatableMixin {
  ...
  static PresentationPage? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
...
class PresentationSpread with EquatableMixin {
  ...
  static PresentationSpread? from(String? value) => _values.firstOrNullWhere((element) => element.value == value);
}
