...
import 'condition_predicate.dart';
...
abstract class Predicate<T> {
  ...
  void addEqualsCondition(String field, Object value) {
    conditionsPredicate.add(ConditionPredicate(ConditionType.isEqualTo, field, value));
  }

  void addContainsCondition(String field, Object value) {
    conditionsPredicate.add(ConditionPredicate(ConditionType.contains, field, value));
  }

  void addGreaterThanCondition(String field, Object value) {
    conditionsPredicate.add(ConditionPredicate(ConditionType.isGreaterThan, field, value));
  }

  void addArrayContainsCondition(String field, String value) {
    conditionsPredicate.add(ConditionPredicate(ConditionType.arrayContains, field, value));
  }
  ...
  void _addInArrayCondition(String field, List<Object> value, ConditionType conditionType) {
  ...
  @override
  String toString() => 'Predicate{dbOnly: $dbOnly, conditionsPredicate: $conditionsPredicate}';
}
