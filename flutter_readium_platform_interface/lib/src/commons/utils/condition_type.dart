...
class ConditionType {
  const ConditionType._(this.id, this.name, this.maxListItems, this.inequalityOperator);
  static const ConditionType isGreaterThan = ConditionType._(0, 'isGreaterThan', 1, true),
  ...
  static const List<ConditionType> _values = [isGreaterThan, isLessThan, isEqualTo];
  ...
  static ConditionType from(int id) => _values.firstWhere((type) => type.id == id);
